fn main(){
   ...
   println!("The course learning outcomeis as follows:");

   println!("1. Distinguish between the computer and computer programming,/n
   	         2. Develop some techniques in computer science,/n 
   	         3. Understand the diffrent areas of study in computer science,/n 
