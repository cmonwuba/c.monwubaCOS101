...
115	Oghenero Ager	50	o_agor@gmail.com	7055566774	117	11
...
COPY public.dataplan (data_id, data_size_gb, data_duration_days, data_price_naira) FROM stdin;
1	350	2	200
2	1.8	14	500
3	3.9	30	1000
4	7.5	30	1500
...
COPY public.project (pno, pname, pduration_in_months, project_managerid) FROM stdin;
11	A	9	102
22	B	14	97
33	C	16	120
44	D	25	108
